...
public class SolidRockHostModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.ApplicationName = "SolidRock.Host";
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "SolidRockIdentity.HttpApi.xml"), true);
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "SolidRockIdentity.UseCase.xml"), true);
        });
